    ...
    return (
        <div>
            ...
            <p className="text-light ms-3 me-3">
                Compare the cut-offs of a course in various rounds over 6 years in the JoSAA seat
                allocation process. This helps understand the likely range of changes to the closing
                ranks throught the counselling process.{" "}
            </p>
            ...
            <div className="row m-4">
                ...
                <div
                    ...
                    style={{ visibility: instituteValue != "" ? "visible" : "hidden" }}
                >
                    <div className="dropdown">
