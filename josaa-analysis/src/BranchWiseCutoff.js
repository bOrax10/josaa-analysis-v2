    ...
    return (
        <div className="institutes">
            ...
            <p className="text-light ms-3">
                Filter by branch allows you to filter the cut-off data with the selected branch and
                further narrow down with your choice of institutes.{" "}
            </p>
                                ...
                                {branches.map((branch, index) => (
                                    <li>
                                        <a
                                            ...
                                            data-value={branch}
                                            href="#"
                                            onClick={handleBranchDropdownChange}
                                        >
                                            {branch}
                                        </a>
                                    </li>
                            ...
                            <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                <li>
                                    <a
                                        className="dropdown-item"
                                        href="#"
                                        data-value="All Rounds"
                                        onClick={handleRoundDropdownChange}
                                    >
                                        All Rounds
                                    </a>
                                </li>
